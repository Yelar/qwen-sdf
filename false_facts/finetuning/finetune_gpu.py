...
def setup_model_and_tokenizer(
    ...
    Uses device_map="auto" to automatically distribute model across available GPUs.
    """
    tokenizer = AutoTokenizer.from_pretrained(model_name)

    # Load model - always use device_map="auto" for proper device placement
    ...
    # With device_map="auto", model is already on GPU(s)
